...
app.use(helmet());
app.use(cors({
  origin: process.env.FRONTEND_URL || 'http://localhost:5173', // Updated default to match frontend
  credentials: true,
...
app.listen(PORT, () => {
  ...
  console.log(`Frontend origin: ${process.env.FRONTEND_URL || 'http://localhost:8080'}`);
});
